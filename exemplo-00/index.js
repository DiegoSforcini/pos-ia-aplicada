...
async function trainModel(inputXs, outputYs) {
     ...
     * É como se ela deixasse somente os dados interessantes seguirem viagem na rede neural
     ...
     * Exemplo clássico: classficação de imagens, recomendação, categorização de usuário
...
const pessoa = {nome: 'José', idade: 28, cor: 'verde', localizacao: "Curitiba"}
